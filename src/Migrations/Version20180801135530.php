 ...
 */
final class Version20180801135530 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, section_id INT DEFAULT NULL, user_id INT NOT NULL, title VARCHAR(120) NOT NULL, description LONGTEXT NOT NULL, price DOUBLE PRECISION NOT NULL, creation_date DATETIME NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_54F1F40B12469DE2 (category_id), INDEX IDX_54F1F40BD823E37A (section_id), INDEX IDX_54F1F40BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(60) NOT NULL, section VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
